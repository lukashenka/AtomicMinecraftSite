 ...
 */
class User extends \Atomic\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setServerId($servId);
    }
    ...
    {
        $this->__load();
        return parent::setBanned($status);
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'coins', 'sesId', 'serverId', 'banned', 'right', 'group', 'duration', 'money', 'ban_count', 'registered', 'comments', 'transactions', 'cloak', 'skin', 'groups');
    }
