 ...
 */
class Blog extends \Atomic\BlogBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setComment($comments);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'blog', 'image', 'tags', 'created', 'updated', 'author', 'comments');
    }
